...
namespace Coffee.UIExtensions
{
...
#endif
	{
		...
		{
			get { return m_EffectMaterial; }
			set
			{
                m_EffectMaterial = value;
        ...
        public void PlayToLoop()
		{
            ...
            if (graphic.material != effectMaterial)
			{
				graphic.material = effectMaterial;
            }

			enumerator = CoPlayToLoop(1, AnimatorUpdateMode.Normal);
            StartCoroutine(enumerator);
        }

        IEnumerator CoPlayToLoop(float duration, AnimatorUpdateMode updateMode = AnimatorUpdateMode.Normal)
		{
            float time = 0;
            while (true)
            {
        ...
        public void Play(float duration)
		{
            ...
            enumerator = CoPlay(duration, AnimatorUpdateMode.Normal);
            StartCoroutine(enumerator);
        }
		...
		public void Play(float duration, AnimatorUpdateMode updateMode)
		{
            ...
            enumerator = CoPlay(duration, updateMode);
            StartCoroutine(enumerator);
        }
